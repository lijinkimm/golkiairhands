(() => {
  ...
  const mechanismSteps = [
    { title: '압박', desc: '에어백이 정교하게 수축하며 강력하면서도 균일한 압력을 생성합니다. 얼굴 전체를 안정적으로 감싸 깊은 밀착감을 제공하고, 지압 시스템과 함께 최적의 압박 환경을 형성하여 보다 효과적인 페이스 케어를 지원합니다.' },
    { title: '자극', desc: '특수 지압볼 시스템이 얼굴의 주요 경락 포인트를 섬세하고 정밀하게 자극합니다. 에어백의 압박과 유기적으로 결합되어 깊고 균일한 자극을 전달하며, 얼굴 윤곽을 따라 편안하면서도 효과적인 케어 환경을 제공합니다.' },
    { title: '순환', desc: '에어백의 리드미컬한 압박과 특수 지압볼 시스템이 함께 작용하여 혈액과 림프의 순환을 활성화합니다. 부드럽고 균일한 자극이 얼굴 전체의 순환을 도와 피부에 생기를 더하고, 더욱 건강하고 탄력 있는 페이스 컨디션을 유지할 수 있도록 지원합니다.' },
    { title: '탄력', desc: '에어백의 리드미컬한 압박과 특수 지압볼 시스템이 긴장된 얼굴 근육을 부드럽게 이완시키고 피부 탄력 개선에 도움을 줍니다. 얼굴 전체에 균일한 케어를 제공하여 보다 탄탄하고 매끄러운 페이스 라인을 유지할 수 있도록 지원합니다.' },
  ];
